...
- Legacy note: if `Settings_File_Guard.DeepDiagnostics.enabled` already exists from older builds, it is treated only as the initial default for the new settings UI.
